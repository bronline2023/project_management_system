...
function getMasterPermissionsList() {
    return [
        ...
        'B2B SaaS Dashboards' => [
            ...
            'district_manager_dashboard' => 'District Manager Dashboard',
            'retailer_dashboard' => 'Retailer Dashboard'
        ],
        'Digital Services' => [
            'poster_studio' => 'Poster Design Studio',
            'resume_builder' => 'Resume Builder',
            'smart_card' => 'Smart Card Creator',
            'passport_photo' => 'Passport Photo Maker',
            'document_converter' => 'Document Converter',
            'size_converter' => 'Size Converter',
            'photo_studio' => 'Photo Studio Pro',
        ]
    ];
}
