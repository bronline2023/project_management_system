 ...
 * - Added 'Payment Collected By' field.
 */
$pdo = connectDB();
$message = '';
        ...
        <form action="index.php" method="POST" id="assignTaskForm" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <small class="text-muted">Total amount to be collected from customer</small>
                </div>
                ...
                <div class="col-md-3 mb-3" id="task_price_container">
                    ...
                    <small class="text-muted">Amount to be paid to freelancer</small>
                </div>
            ...
            <div class="row">
                 <div class="col-md-6 mb-3">
                    <label for="payment_collected_by" class="form-label fw-bold text-warning">Payment Collected By <span class="text-danger">*</span></label>
                    <select class="form-select border-warning" id="payment_collected_by" name="payment_collected_by" required>
                        <option value="company">Company</option>
                        <option value="self">Freelancer / Self</option>
                    </select>
                    <small class="text-muted">Select 'Company' if payment was received by the company, select 'Freelancer' if the freelancer collected cash.</small>
                </div>
            </div>
