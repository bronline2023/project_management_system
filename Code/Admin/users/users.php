...
/**
 * admin/users.php
 * FINAL UPDATED: Added 'Recalculate Balance' and 'Download Statement' features.
 */
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="<?= !empty($user['profile_picture']) ? UPLOADS_URL . $user['profile_picture'] : ASSETS_URL . 'images/default_avatar.png' ?>" class="rounded-circle border me-2" width="40" height="40" style="object-fit:cover;">
                                    <div>
                            ...
                            <td class="text-center">
                                <a href="<?= BASE_URL ?>user/export_statement.php?user_id=<?= $user['id'] ?>" class="btn btn-sm btn-success" title="Download Statement" target="_blank">
                                    <i class="fas fa-file-excel"></i>
                                </a>

                                <a href="index.php?page=edit_user&id=<?= $user['id'] ?>" class="btn btn-sm btn-primary" title="Edit User"><i class="fas fa-edit"></i></a>
                                
                                <?php if ($user['id'] != 1 && $user['id'] != $_SESSION['user_id']): ?>
                                <form action="index.php" method="POST" class="d-inline" onsubmit="return confirm('Delete user? This will reassign tasks to Admin.');">
...
<?php include VIEWS_PATH . 'register.php'; // Includes the modal for Adding User ?>