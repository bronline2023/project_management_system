...
if(isset($_POST['mark_attendance'])){
    ...
    if(markAttendance($user_id, $entry_date, $status, $check_in, $check_out)){
        $message = '<div class="alert alert-success">Attendance marked successfully.</div>';
    } else {
        $message = '<div class="alert alert-danger">Failed to mark attendance. It might already be marked for this date.</div>';
    }
}
    ...
    <div class="card-body">
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="attendance">
                ...
                <form method="POST" action="?page=hr_management">
                    <div class="row">
