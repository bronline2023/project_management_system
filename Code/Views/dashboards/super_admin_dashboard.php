<?php
/**
 * views/dashboards/super_admin_dashboard.php
 * Custom B2B Super Admin Dashboard View
 */
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="fw-bold"><i class="fas fa-shield-alt text-danger"></i> Super Admin Dashboard</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm border-0 border-start border-info border-4">
                <div class="card-body">
                    <h5 class="text-muted fw-bold">Active Portals</h5>
