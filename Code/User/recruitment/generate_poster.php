 ...
 * FIXED: Clean logic and accurate redirect handling.
 */
?>

<script src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js"></script>

<h2 class="mb-4 fw-bold text-dark"><i class="fas fa-magic text-primary me-2"></i>Recruitment & Scheme Poster Generator</h2>

<div class="row g-4">
    <div class="col-lg-5">
        <div class="card shadow-sm border-0 rounded-4 h-100">
            <div class="card-header bg-primary text-white rounded-top-4 py-3">
                <h5 class="mb-0 fw-bold"><i class="fas fa-cogs me-2"></i>Poster Settings</h5>
            </div>
            <div class="card-body bg-light" style="max-height: 80vh; overflow-y: auto;">
                <div class="mb-3">
                    <label class="form-label fw-bold">1. Select Poster Theme:</label>
                    <select id="designSelector" class="form-select shadow-sm">
                ...
                <div class="mb-3">
                    <label class="form-label fw-bold">2. Background (Optional):</label>
                    <select id="backgroundSelector" class="form-select shadow-sm">
                ...
                <div class="mb-3">
                    <label class="form-label fw-bold">3. Upload Custom Background:</label>
                    <input type="file" id="backgroundUpload" class="form-control shadow-sm" accept="image/*">
                </div>

                <div id="recruitment-form">
                    <h5 class="mt-4 border-bottom border-secondary pb-2 fw-bold text-primary">Header Content</h5>
                    <div class="mb-3"><label class="form-label fw-bold">Organization Name</label><input type="text" id="orgName" class="form-control shadow-sm" placeholder="e.g., Railway Recruitment Board"></div>
                    <div class="mb-3"><label class="form-label fw-bold">Recruitment Title</label><input type="text" id="recruitmentTitle" class="form-control shadow-sm" placeholder="e.g., Technician Grade-I"></div>
                    
                    <h5 class="mt-4 border-bottom border-secondary pb-2 fw-bold text-primary">Information Boxes</h5>
                    <div class="mb-3"><label class="form-label fw-bold text-info">Vacancies Box</label><input type="text" id="vacanciesTitle" class="form-control mb-1 shadow-sm" value="Total Vacancies"><input type="text" id="totalVacancies" class="form-control shadow-sm" placeholder="e.g., 9144 Posts"></div>
                    <div class="mb-3"><label class="form-label fw-bold text-info">Eligibility Box</label><input type="text" id="eligibilityTitle" class="form-control mb-1 shadow-sm" value="Eligibility"><textarea id="eligibility" class="form-control shadow-sm" rows="2" placeholder="e.g., ITI / Diploma / Degree"></textarea></div>
                    <div class="mb-3"><label class="form-label fw-bold text-info">Age Limit Box</label><input type="text" id="ageLimitTitle" class="form-control mb-1 shadow-sm" value="Age Limit"><input type="text" id="ageLimit" class="form-control shadow-sm" placeholder="e.g., 18 to 36 Years"></div>
                    <div class="mb-3"><label class="form-label fw-bold text-info">Fees Details Box</label><input type="text" id="feesDetailsTitle" class="form-control mb-1 shadow-sm" value="Fees Details"><input type="text" id="feesDetails" class="form-control shadow-sm" placeholder="e.g., General: ₹500/-"></div>
                </div>

                <div id="yojana-form" style="display: none;">
                    <h5 class="mt-4 border-bottom pb-2">Scheme Details</h5>
                    <div class="mb-3"><label class="form-label fw-bold">Scheme Name</label><input type="text" id="yojanaName" class="form-control" placeholder="e.g., PM-Kisan Samman Nidhi"></div>
                    <div class="mb-3"><label class="form-label fw-bold">Benefits</label><textarea id="yojanaBenefits" class="form-control" rows="3" placeholder="Enter scheme benefits..."></textarea></div>
                    <div class="mb-3"><label class="form-label fw-bold">Eligibility</label><textarea id="yojanaEligibility" class="form-control" rows="3" placeholder="Enter eligibility criteria..."></textarea></div>
                    <div class="mb-3"><label class="form-label fw-bold">Required Documents</label><textarea id="yojanaDocuments" class="form-control" rows="3" placeholder="Enter required documents..."></textarea></div>
                </div>

                <h5 class="mt-4 border-bottom border-secondary pb-2 fw-bold text-primary">Dates & Links</h5>
                <div class="form-check mb-3" id="date-enabler-container" style="display: none;">
                    ...
                    <label class="form-check-label fw-bold" for="enableDates">Enable Start/End Dates</label>
                </div>
                <div class="row g-2" id="date-fields-container">
                    <div class="col-md-6 mb-3"><label class="form-label fw-bold">Start Date</label><input type="date" id="startDate" class="form-control shadow-sm"></div>
                    <div class="col-md-6 mb-3"><label class="form-label fw-bold text-danger">Last Date</label><input type="date" id="endDate" class="form-control shadow-sm border-danger"></div>
                </div>
                <div class="mb-3"><label class="form-label fw-bold">Official Website</label><input type="text" id="website" class="form-control shadow-sm" placeholder="e.g., www.indianrailways.gov.in"></div>
                <div class="mb-3"><label class="form-label fw-bold">Your Company Website</label><input type="text" id="companyWebsite" class="form-control shadow-sm" value="www.bronline.net"></div>
                
                <h5 class="mt-4 border-bottom border-secondary pb-2 fw-bold text-primary">Logos</h5>
                <div class="mb-3"><label class="form-label fw-bold">Upload Official Logo</label><input type="file" id="logoUpload" class="form-control shadow-sm" accept="image/*"></div>
                
                <div class="d-grid mt-4 mb-2">
                    <button id="saveAndRedirectBtn" class="btn btn-success btn-lg fw-bold shadow"><i class="fas fa-save me-2"></i>Save Poster & Redirect</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-7">
        <div class="card shadow-sm border-0 rounded-4 h-100">
            <div class="card-header bg-dark text-white rounded-top-4 py-3"><h5 class="mb-0 fw-bold"><i class="fas fa-eye text-warning me-2"></i>Live Preview</h5></div>
            <div class="card-body bg-secondary d-flex align-items-center justify-content-center p-2 p-md-4">
                
                <div id="poster-canvas" class="poster-container bg-white">
                    <div class="poster-header">
                        <div class="poster-logo-container"><img id="logo-preview" src="<?= defined('BASE_URL') ? BASE_URL : '/' ?>uploads/logo/logo.png" onerror="this.style.display='none'" alt="Logo"></div>
                        <div class="poster-org-details"><h1 id="org-name-preview">Organization Name</h1><p id="website-preview">www.example.com</p></div>
                    </div>
                    ...
                    <div class="poster-body yojana-body" style="display: none;">
                        <div class="poster-info-grid">
                             <div class="poster-info-box"><div class="poster-info-icon"><i class="fas fa-hands-helping"></i></div><div class="poster-info-content"><h3>Benefits</h3><p id="yojana-benefits-preview">Benefits details here.</p></div></div>
                             <div class="poster-info-box"><div class="poster-info-icon"><i class="fas fa-check-circle"></i></div><div class="poster-info-content"><h3>Eligibility</h3><p id="yojana-eligibility-preview">Eligibility details here.</p></div></div>
                             <div class="poster-info-box"><div class="poster-info-icon"><i class="fas fa-file-alt"></i></div><div class="poster-info-content"><h3>Documents</h3><p id="yojana-documents-preview">Document details here.</p></div></div>
                        </div>
                    </div>
                    ...
                    <div class="poster-company-footer">
                        <div class="poster-company-logo"><img id="company-logo-preview" src="<?= defined('BASE_URL') ? BASE_URL : '/' ?>uploads/logo/logo.png" onerror="this.style.display='none'" alt="Company Logo"></div>
...
<style>
    ...
    .design-sarkari-yojana { background: linear-gradient(135deg, #e3f2fd, #bbdefb); color: #0d47a1; border: 2px solid #0d47a1;} .design-sarkari-yojana::after { content: ''; background: radial-gradient(circle, rgba(13,71,161,0.05) 0%, rgba(255,255,255,0) 70%); top: 0; left: 0; bottom: 0; right: 0; position: absolute; z-index: 0; } .design-sarkari-yojana > * { z-index: 1; } .design-sarkari-yojana .poster-title h2 { color: #d32f2f; font-weight: bold; text-transform: uppercase; background: rgba(255,255,255,0.7); padding: 10px; border-radius: 5px;} .design-sarkari-yojana .poster-body { padding: 1.5rem; } .design-sarkari-yojana .poster-info-box { background: rgba(255,255,255,0.8); border-left: 5px solid #0d47a1; box-shadow: 0 2px 5px rgba(0,0,0,0.1); } .design-sarkari-yojana .poster-info-icon { color: #0d47a1; } .design-sarkari-yojana .poster-info-content h3 { color: #555; } .design-sarkari-yojana .poster-info-content p { color: #111; font-weight: bold; } .design-sarkari-yojana .poster-footer { background: #0d47a1; color: #fff; } .design-sarkari-yojana .poster-company-footer { background: #bbdefb; }
    
    .design-ai-futuristic { background: #121212; color: #e0e0e0; font-family: 'Roboto', sans-serif; } .design-ai-futuristic .poster-header { border-bottom: 1px solid rgba(139, 92, 246, 0.5); } .design-ai-futuristic .poster-org-details h1 { color: #fff; } .design-ai-futuristic .poster-org-details p { color: #aaa; } .design-ai-futuristic .poster-title h2 { color: #8B5CF6; } .design-ai-futuristic .poster-info-box { background: #1E1E1E; border: 1px solid #333; border-left: 4px solid #8B5CF6; } .design-ai-futuristic .poster-info-icon { color: #8B5CF6; } .design-ai-futuristic .poster-footer { background: linear-gradient(90deg, #8B5CF6, #EC4899); color: #fff; } .design-ai-futuristic .poster-company-footer { background: #1E1E1E; }
    ...
    .bg-texture-1 { background-image: url('data:image/svg+xml,%3Csvg width="6" height="6" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="%23d4d4d4" fill-opacity="0.4"%3E%3Cpath d="M5 0h1L0 6V5zM6 5v1H5z"/%3E%3C/g%3E%3C/svg%3E') !important; background-color: #ffffff !important; }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updatePosterClasses() {
        ...
        posterCanvas.className = 'poster-container bg-white';
    ...
    inputs.logoUpload.addEventListener('change', function(event) {
        if (event.target.files && event.target.files[0]) {
            const reader = new FileReader();
            reader.onload = e => { 
                previews.logo.src = e.target.result; 
    ...
    // --- [ 100% FIXED DIRECT BUTTON SAVE LOGIC WITH ABSOLUTE URL REDIRECT ] ---
    document.getElementById('saveAndRedirectBtn').addEventListener('click', function() {
        const btn = this;
        const originalText = btn.innerHTML;
        
        btn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i> Generating & Saving...';
        btn.disabled = true;
        ...
        setTimeout(() => {
            ...
            .then(canvas => {
                ...
                fetch('user/recruitment/save_poster.php', {
                    method: 'POST',
                ...
                .then(data => {
                    if (data.success) {
                        btn.innerHTML = '<i class="fas fa-check-circle me-2"></i> Success! Redirecting...';
                        window.location.href = 'index.php?page=add_recruitment_post&image_url=' + encodeURIComponent(data.imageUrl);
                    } else {
            ...
            .catch(err => {
                ...
                alert('Image Generation Error: Ensure custom images are correctly loaded.');
                btn.innerHTML = originalText;
                btn.disabled = false;
            });
        }, 500); 
