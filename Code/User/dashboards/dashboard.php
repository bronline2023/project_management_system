...
<div class="container-fluid user-dashboard">
    ...
    <?php if(!IS_TENANT): 
        // B2C Specific Logic for Master Portal
        $wallet_balance = fetchColumn($pdo, "SELECT balance FROM users WHERE id = ?", [$currentUserId]);
    ?>
        <div class="row mb-4">
            <!-- B2C Upgrade Banner -->
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div class="card bg-gradient-primary text-white shadow h-100 py-2" style="background: linear-gradient(45deg, #4e73df, #224abe);">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <h4 class="font-weight-bold text-uppercase mb-1">Scale Your Business!</h4>
                                <div class="mb-0">Get your own dedicated portal, custom domain, and isolated database with our B2B SaaS plans.</div>
                            </div>
                            <div class="col-auto">
                                <a href="?page=upgrade_b2b" class="btn btn-light text-primary fw-bold shadow-sm"><i class="fas fa-rocket me-2"></i>Upgrade to B2B Subscription</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">My Wallet Balance</div>
                                <div class="h3 mb-0 font-weight-bold text-gray-800">₹<?= number_format((float)$wallet_balance, 2) ?></div>
                                <a href="?page=wallet_recharge" class="btn btn-sm btn-outline-success mt-2"><i class="fas fa-plus-circle"></i> Recharge Wallet</a>
                            </div>
                            <div class="col-auto">
