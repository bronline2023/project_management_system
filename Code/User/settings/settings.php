    ...
    <div class="col-lg-4">
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body text-center">
                <img src="<?= !empty($_SESSION['user_profile_picture']) ? UPLOADS_URL . htmlspecialchars($_SESSION['user_profile_picture']) : ASSETS_URL . 'images/default_avatar.png' ?>" alt="Profile Picture" class="img-thumbnail rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
