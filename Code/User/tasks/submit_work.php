            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 border-left">
                        ...
                        <small class="text-muted">Amount to be collected from the customer</small>
                    </div>
                    <div class="col-md-4 border-left">
                ...
                <form action="index.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-4 p-3 border rounded bg-light">
                        <label class="form-label font-weight-bold text-dark" style="font-size: 1.1em;">
                            Payment Collected By? <span class="text-danger">*</span>
                        </label>
                        ...
                        <div class="mt-2 small text-muted">
                            ...
                            If you select 'Self', the company share will be deducted from your wallet.
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="text-muted">Upload your work file here.</small>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="text-muted">Payment receipt or screenshot.</small>
                        </div>
                    </div>
