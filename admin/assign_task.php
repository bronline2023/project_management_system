 ...
 * FINAL & COMPLETE: 
 * - All original form fields have been restored.
 * - [NEW] JavaScript added to handle client_id and auto-fill it when a customer is selected.
 * - [NEW] Admin user is disabled in the 'Assign To' dropdown.
 * - [NEW] Added Payment Status dropdown for tracking earnings.
 */
$pdo = connectDB();
$message = '';
...
$paymentStatuses = ['Pending', 'Partially Paid', 'Paid']; // New array for statuses
?>
            ...
            <div class="row">
             ...
             <div class="row">
                ...
                <div class="col-md-3 mb-3" id="task_price_container" style="display: none;">
                    ...
                    <input type="number" step="0.01" class="form-control" id="task_price" name="task_price" value="0.00">
                </div>
                <div class="col-md-3 mb-3">
